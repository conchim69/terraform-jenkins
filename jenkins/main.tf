...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i /Users/tpsolutions.it.com/.ssh/aws_ec2_terraform ubuntu@", aws_instance.jenkins_ec2_instance_ip.public_ip)
}
...
output "devproj1_ec2_instance_public_ip" {
